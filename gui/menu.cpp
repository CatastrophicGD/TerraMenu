...
namespace Menu {
        ...
        std::map<std::string, std::vector<std::string>> categories = {
                {"Settings", {"Show Keybinds", "Allow Activating Keybinds while Chatting", "Always Show Menu on Startup", "Panic (Disable TerraMenu)",
                                          ...
                                          "Replace Streamer Mode Lobby Code", "RGB Lobby Code", "Unlock Cosmetics", "Safe Mode", "Allow other TerraMenu users to see you're using TerraMenu",
                ...
                {"Self", {"Max Vision", "Wallhack", "Disable HUD", "Freecam", "Zoom", "Always show Chat Button", "Allow Ctrl+(C/V) in Chat", "Read Messages by Ghosts",
                                  "Read and Send TerraChat", "Custom Name", "Custom Name for Everyone", "Server-sided Custom Name", "Reveal Roles", "Abbrv. Role", "Player Colored Dots Next To Names",
        ...
        void Render() {
                try {
                        ...
                        ImGui::BeginChild("###TerraMenu", ImVec2(95 * State.dpiScale, 0), true, ImGuiWindowFlags_NoBackground);
                        // Search field
                        ImGui::SetNextItemWidth(95 * State.dpiScale); // Adjust the width of the input box
                        ...
                        if (!isPanicWarning) {
                                ...
                                bool panicKeybind = State.KeyBinds.Toggle_Terra != 0x00;
                                ...
                                if (!panicKeybind) {
                                        ...
                                        ImGui::TextColored(PanicCol, ("Press " + (std::string)KeyBinds::ToString(State.KeyBinds.Toggle_Terra)).c_str());
