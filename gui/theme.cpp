...
void ApplyTheme()
{
        ...
        style.Colors[ImGuiCol_Border] = ImVec4(0.30f, 0.30f, 0.30f, 0.35f);
        ...
        style.WindowRounding = 10.0f * State.RoundingRadiusMultiplier;
        ...
        style.GrabRounding = 4.0f * State.RoundingRadiusMultiplier;
