...
- **Allow other TerraMenu users to see you're using TerraMenu** Allows TerraMenu users to see other TerraMenu users
### Spoofing
...
- **Panic (Disable TerraMenu)** (Default: PAUSE BREAK)
...
- **Send to AUM** Sends an AUM chat message that can be seen with AmongUsMenu or TerraMenu
