...
## ⚠️ Disclaimer
This project is maintained by **TerraMenu team, with contributions from other developers.  
...
- The developers, including all contributors, **assume no responsibility or liability** for:
...
**By using TerraMenu, you agree to:**
...
> Report unethical usage in our [Discord](https://discord.gg/TerraMenu).
...
- Zoom Out  
- TerraMenu Chat (`/sc [message]`)  

**Full Feature List:** [FEATURES.md](https://github.com/TerraMenu/TerraMenu/blob/main/FEATURES.md)  
...
## ⬇️ Download & Install
### For Windows
You can find the latest release [here](https://github.com/TerraMenu/TerraMenu/releases/latest).
Either inject `TerraMenu.dll` with a reliable injector or put `version.dll` in your Among Us directory (the folder containing `Among Us.exe`).
...
10. TerraMenu should now work properly in the game
...
> [!TIP]
> The hotkey to triggerr TerraMenu depends on your Mac model. There are 2 possible triggers: Command+Backspace **OR** Function+Backspace.
...
6. Start Among Us and press **Fn+Backspace or Command+Backspace, depending on your model** to show TerraMenu.
...
- Use **Command + Backspace or Fn+Backspace** to toggle TerraMenu in-game, depending onn your Mac model.
...
Use Fn + Backspace or Command + Backspace (depending on your Mac model) to toggle TerraMenu.
...
- NoClip - CTRL
- Panic / Disable TerraMenu - PAUSE BREAK (Break)
...
## 💁 Contributing
1. Fork it [here](<https://github.com/TerraMenu/TerraMenu/fork>)
...
* [TerraMenu](https://github.com/scp222thj/TerraMenu) by [scp222thj](https://github.com/scp222thj)
