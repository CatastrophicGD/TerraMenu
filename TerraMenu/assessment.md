Assessment: TerraMenu build after C++ Build Tools upgrade

Summary
- Solution: C:\Users\test\Desktop\TerraMenu\TerraMenu.sln
- Build result (rebuild): 0 errors, 1011 warnings
- Affected project: C:\Users\test\Desktop\TerraMenu\TerraMenu.vcxproj
- Primary affected source: C:\Users\test\Desktop\TerraMenu\user\utility.cpp
...
- All C4244 occurrences in `C:\Users\test\Desktop\TerraMenu\user\utility.cpp` (explicit casts or adjust `srgbToLinear`).
- All C4566 occurrences in `C:\Users\test\Desktop\TerraMenu\user\utility.cpp` by adding `/utf-8` to the project and saving sources as UTF-8.
...
2) Update `C:\Users\test\Desktop\TerraMenu\TerraMenu.vcxproj` (unload project, edit) to add the `/utf-8` compiler flag for relevant configurations (Debug/Release). Validate `.vcxproj` before reload.
3) Re-save `C:\Users\test\Desktop\TerraMenu\user\utility.cpp` as UTF-8 (no code changes required for unicode warnings after /utf-8).
