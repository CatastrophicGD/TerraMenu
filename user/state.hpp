...
public:
    ...
    bool ReadAndSendTerraChat = false;
    ...
    //std::vector<Game::PlayerId> terraUsers;
    ...
    std::string TerraVersion = "v1.0.0";
    ...
    bool IsProcessingTerraChat = false;
